...
public class ProcessTransportAdapter extends RecyclerView.Adapter<ProcessTransportAdapter.MyViewHolder> {
    ...
    public ProcessTransportAdapter(HistoryActivity context,String transid) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.finalbilladapter2, parent, false);
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
       ...
       /* holder.txtJobStatus.setText("Status : "+mOrder.getStatus_name());
        ...
        if(mOrder.getStatus_name().equalsIgnoreCase("On Process")){
            holder.txtConfirm.setText("Process");
        }*/
    ...
    private void confirmOrder(final TransportList mOrder) {
        ...
        progressDialog.show();
        context.apiService.transportConfirm(APIUrl.KEY,transid,mOrder.getTrnreqid(),mOrder.getTrnreqcusid()).enqueue(new Callback<ResponseResult>() {
            @Override
            public void onResponse(Call<ResponseResult> call, Response<ResponseResult> response) {
                ...
                if (Integer.parseInt(response.body().getResponse()) == 101) {
                    Toasty.success(context, "Process Transport Order Confirm", Toast.LENGTH_LONG).show();

...
public class ChangePasswordActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void init()
    {
        ...
        customer_id = prefManager.getString("transport_id");
        prefManager.closeDB();
        ...
        switch (v.getId())
        {
            case R.id.btnChangePassword:
                ...
                if(TextUtils.isEmpty(new_password)){
                    Toasty.error(ChangePasswordActivity.this,"Enter New Password",Toasty.LENGTH_SHORT).show();
                    return;
                }
                if(new_password.length() < 6){
                    Toasty.error(ChangePasswordActivity.this,"New Password Is Less Than 6 Letters",Toasty.LENGTH_SHORT).show();
                    return;
                }
                if(TextUtils.isEmpty(comfrim_password)){
                    Toasty.error(ChangePasswordActivity.this,"Enter Confirm Password",Toasty.LENGTH_SHORT).show();                    return;
                }
    ...
    private void changePassword(String customer_id, String new_password) {
        ...
        Call<ResponseResult> call = apiService.callChangePassword(APIUrl.KEY,customer_id,new_password
        );

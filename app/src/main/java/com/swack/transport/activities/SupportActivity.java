...
import com.swack.transport.model.SupportListModel;
...
//        swipeContainer.setRefreshing(false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(location).title(getResources().getString(R.string.app_name_office)));
